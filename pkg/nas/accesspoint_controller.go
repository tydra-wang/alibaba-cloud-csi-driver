...
func (c *accesspointController) DeleteVolume(context.Context, *csi.DeleteVolumeRequest, *corev1.PersistentVolume) (*csi.DeleteVolumeResponse, error) {
	return nil, nil
}

func (c *accesspointController) ControllerExpandVolume(context.Context, *csi.ControllerExpandVolumeRequest, *corev1.PersistentVolume) (*csi.ControllerExpandVolumeResponse, error) {
	return nil, nil
}
